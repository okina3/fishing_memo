...
class DeleteContactRequestTest extends TestCase
{
   ...
   // DeleteContactRequest インスタンスを作成するヘルパーメソッド
   private function deleteContactRequest(): DeleteContactRequest
   {
      // DeleteContactRequestのインスタンスを返す
   ...
   public function testAuthorizeReturnsTrue()
   {
      ...
      $request = $this->deleteContactRequest();
