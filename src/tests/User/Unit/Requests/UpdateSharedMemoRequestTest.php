...
class UpdateSharedMemoRequestTest extends TestCase
{
    ...
    // UpdateSharedMemoRequest のインスタンスを作成ヘルパーメソッド
    private function updateSharedMemoRequest(): UpdateSharedMemoRequest
    {
        // UpdateSharedMemoRequestのインスタンスを返す
        return new UpdateSharedMemoRequest();
    }
    ...
    public function testAuthorizeReturnsTrue()
    {
        ...
        $request = $this->updateSharedMemoRequest();
