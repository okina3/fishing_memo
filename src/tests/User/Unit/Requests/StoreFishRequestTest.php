...
class StoreFishRequestTest extends TestCase
{
    ...
    // StoreFishRequestのインスタンスを作成するヘルパーメソッド
    private function storeFishRequest(): StoreFishRequest
    {
        // StoreFishRequestのインスタンスを返す
        return new StoreFishRequest();
    }
