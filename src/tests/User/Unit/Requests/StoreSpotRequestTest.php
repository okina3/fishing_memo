...
class StoreSpotRequestTest extends TestCase
{
    ...
    // StoreSpotRequest のインスタンスを作成するヘルパーメソッド
    private function storeSpotRequest(): StoreSpotRequest
    {
        // StoreSpotRequestのインスタンスを返す
        return new StoreSpotRequest();
    }
