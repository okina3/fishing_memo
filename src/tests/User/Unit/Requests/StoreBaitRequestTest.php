...
class StoreBaitRequestTest extends TestCase
{
    ...
    // StoreBaitRequestのインスタンスを作成するヘルパーメソッド
    private function storeBaitRequest(): StoreBaitRequest
    {
        // StoreBaitRequestのインスタンスを返す
        return new StoreBaitRequest();
    }
