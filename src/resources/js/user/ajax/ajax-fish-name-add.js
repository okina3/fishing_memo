...
document.addEventListener('DOMContentLoaded', () => {
   ...
   const input = document.getElementById('fish_name_input');
   const select = document.getElementById('fish-name-select');
   ...
   const addFish = async (newFish) => {
      const url = addBtn.dataset.url || '/fish-name/store-ajax';
      const headers = {
